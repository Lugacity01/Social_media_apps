...
// ==================== CREATE MESSAGE
// POST : api/messages/:receiverId and is a PROTECTED ROUTE

const createMessage = async (req, res, next) => {
  try {
    const { receiverId } = req.params;
    const { messageBody } = req.body;
    // Check if there already a conversation btw current user and receiver
...
// ==================== GET MESSAGE
// GET : api/messages/:receiverId and is a PROTECTED ROUTE
...
const getMessages = async (req, res, next) => {
  try {
    ...
    if (!conversation) {
      // 🤝 No conversation yet? Just send an empty list
...
// ==================== GET CONVERSATIONS
// GET : api/conversation and is a PROTECTED ROUTE
